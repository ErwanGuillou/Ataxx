...
// Negamax var
var AlphaVal    =   -(64 - nHoles);
var BetaVal     =   (64 - nHoles);
...
function getPossibleMoves(board, player){
    ...
    if (board[22] === player) {
        ...
        if (board[23] === 0 && m_23 === 0) {
            possibleMoves[i++] = [22, 23, 0];
            m_23 = 1;
        }
        if (board[34] === 0 && m_34 === 0) {
            possibleMoves[i++] = [22, 34, 0];
            m_34 = 1;
        }
        if (board[35] === 0 && m_35 === 0) {
    ...
    if (board[23] === player) {
        ...
        if (board[22] === 0 && m_22 === 0) {
            possibleMoves[i++] = [23, 22, 0];
            m_22 = 1;
        }
        if (board[24] === 0 && m_24 === 0) {
    ...
    if (board[34] === player) {
        ...
        if (board[46] === 0 && m_46 === 0) {
            possibleMoves[i++] = [34, 46, 0];
            m_46 = 1;
        }
        if (board[47] === 0 && m_47 === 0) {
    ...
    if (board[46] === player) {
        ...
        if (board[58] === 0 && m_58 === 0) {
            possibleMoves[i++] = [46, 58, 0];
            m_58 = 1;
        }
        if (board[59] === 0 && m_59 === 0) {
    ...
    if (board[58] === player) {
        ...
        if (board[70] === 0 && m_70 === 0) {
            possibleMoves[i++] = [58, 70, 0];
            m_70 = 1;
        }
        if (board[71] === 0 && m_71 === 0) {
    ...
    if (board[70] === player) {
        ...
        if (board[82] === 0 && m_82 === 0) {
            possibleMoves[i++] = [70, 82, 0];
            m_82 = 1;
        }
        if (board[83] === 0 && m_83 === 0) {
    ...
    if (board[82] === player) {
        ...
        if (board[94] === 0 && m_94 === 0) {
            possibleMoves[i++] = [82, 94, 0];
            m_94 = 1;
        }
        if (board[95] === 0 && m_95 === 0) {
    ...
    if (board[94] === player) {
        ...
        if (board[106] === 0 && m_106 === 0) {
            possibleMoves[i++] = [94, 106, 0];
            m_106 = 1;
        }
        if (board[107] === 0 && m_107 === 0) {
...
function bEval(board, player){
    ...
    let scoreAi     =   scores[0];
    let scoreHuman  =   scores[1];

    // Si IA n'a plus de pièce, renvoyer une alerte extrême !
    if(scoreAi === 0){
        return player * -1000;
    }

    // Si Human perdu, on renvoie un indice positif
    if(scoreHuman === 0){
        return player * 1000;
    }

    // Renvoyer la différence de score
    return player * (scoreAi - scoreHuman);
...
function negaMax(board, depth, player, alpha, beta){
    ...
    let bestValue = AlphaVal;
    let i = possibleMoves.length;
    let value;

    while(i--){
        let move = possibleMoves[i];
        let copiedBoard = getCopyBoard(board);
        copiedBoard = setMove(copiedBoard, player, move);

        value = -(negaMax(copiedBoard, depth + 1, player * -1, -beta, -alpha));
...
function play(player){
    ...
    if(player == Ai){
        ...
        while(i--){
            ...
            // Fonction récursive
            value = -(negaMax(copiedBoard, 1, player * -1, -BetaVal, -AlphaVal));

            // Si la valeur reçue est supérieur à la valeur précédente
            // Alors on a affaire à un meilleur mouvement.
            if(value > bestValue){
                bestValue = value;
                bestMoves = [move];
            ...
            // Sinon, la valeur est égale à la précédente : on l'ajoute aux mouvements.
            else if(value === bestValue){
                bestMoves[k++] = move;
            }
        }

        // Retourner un mouvement au hasard parmi les meilleurs.
